...
const Navbar = () => {
  ...
  return (
    <Nav>
      <NavbarContainer>
        <NavLogo onClick={scrollToTop}>Kashif</NavLogo>
        ...
        {isOpen && (
          <MobileMenu isOpen={isOpen}>
            ...
            <GithubButton href={Bio.linkedin} target="_Blank" style={{background: theme.primary, color: theme.text_primary}}>Github Profile</GithubButton>
          </MobileMenu>
        )}
